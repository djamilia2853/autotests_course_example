...
def everything_for_your_cat(cats_data):
    """
       Функция оптимизации данных таким образом, чтобы для каждого владельца при выводе (одна строка)
       данные о всех его животных отображались в одной строке,
       на новой строке следующий покупатель и все его питомцы и т.д.
       :param cats_data: принимаемый на вход список кортежей
       :return: оптимизированная строка
       """
